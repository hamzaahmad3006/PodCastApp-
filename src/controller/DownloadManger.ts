...
export const DownloadManager = {
    async downloadEpisode(userId: string, episode: any, callbacks: { onProgress?: (percent: number) => void; onComplete?: (episodeId: string) => void }) {
        ...
        try {
            ...
            await DatabaseService.addToLibrary(userId, { ...episode, id: episodeId }, 'downloaded');
